    ...
    <a href="{{route('khachhang.chi-tiet-nuoc-hoa', [Str::slug($nuocHoa['ten_nuoc_hoa'], '-'), $nuocHoa['id']])}}" class="home-product-item">
        ...
        <div class="home-product-item__price">
            ...
            <span class="home-product-item__price-current">
                {!! number_format((float)($nuocHoa['gia_tien'] - ($nuocHoa['gia_tien'] * $nuocHoa['gia_khuyen_mai'] / 100))) !!}
                đ</span>
        </div>
...
<div class="home-load-more" style="width: 100%">
    <a data-id-danh-muc="{{route('khachhang.xem-them-nuoc-hoa-khuyen-mai', $timKhuyenMai['id'])}}" data-last-id="{{$lastId}}" class="category-load-more__btn btn btn--primary" id="xem-them-nuoc-hoa">
        <span>Xem thêm</span>
        <span>Xem thêm</span>
    </a>
</div>
