    ...
    <div class="grid_g wide_g">
        <div class="row_g sm-gutters app__content">
            ...
            <div class="col_g l-10_g m-12_g c-12_g">
                ...
                <!-- Home filter -->
                <form action="{{route('khachhang.khuyen-mai-nuoc-hoa', [Str::slug($timKhuyenMai['ten_khuyen_mai'], '-'), $timKhuyenMai['id']])}}" id="loc-nuoc-hoa" method="GET">
                ...
                <div class="home-product">
                    <div class="row_g sm-gutters" id="them-nuoc-hoa">
                        <!-- <div > -->
                        <!-- Sản Phẩm -->
                        @include('khuyen-mai-nuoc-hoa.nuoc-hoa')
                        <!-- </div> -->
                    </div>
                </div>
