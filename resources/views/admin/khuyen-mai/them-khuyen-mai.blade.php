...
<div class="content-admin content-admin__ckeditor">
    <div class="grid_g">
        <div class="add-form__header add-form__add-account--center add-form__haeder-product">
            <h3 class="add-form__haeding add-form__haeding-product">Thêm Khuyến Mãi</h3>
        </div>

        <form action="{{route('quanly.them-khuyen-mai')}}" method="POST" id="them-khuyen-mai" data-parsley-validate>
            @csrf
            <div class="row_g no-gutters">
                <div class="col_g l-12_g m-12_g">
                    <div class="add-form__group add-form__group-mt">
                        ...
                        <div class="add-form__item">
                            <input type="text" class="add-form__input add-form__input-promotion" name="ten_khuyen_mai" placeholder="Tên khuyến mãi" required data-parsley-required-message="Vui lòng nhập tên khuyến mãi!" autofocus>
                        </div>
                    </div>
                </div>
                ...
                <div class="col_g l-12_g m-12_g">
                    <div class="add-form__group add-form__group-promotion add-form__group-mt">
                        ...
                        <div class="add-form__item">
                            <input type="number" class="add-form__input add-form__input-promotion" name="gia_khuyen_mai" placeholder="Giá khuyến mãi" required data-parsley-required-message="Vui lòng nhập giá khuyến mãi!">
                        </div>
                    </div>
                </div>
                ...
                <div class="col_g l-12_g m-12_g">
                    <div class="add-form__group  add-form__group-never-expires">
                        <input type="checkbox" id="never-expires" class="add-form__input-check" name="vo_han" checked>
...
<!-- Thêm khuyến mãi -->
<script>
    $('#them-khuyen-mai').submit(function(e) {
        e.preventDefault();
